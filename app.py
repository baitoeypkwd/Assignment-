...
st.title("📊 Hotel Amber 85: Buffet Data Visualizations")
st.markdown("สำหรับดูข้อมูลและแคปเจอร์กราฟ (Screenshot) เพื่อนำไปวิเคราะห์ต่อในรายงาน")
...
# ---------------------------------------------------------
# 3. Data Visualizations (2x2 Grid)
# ---------------------------------------------------------
...
st.divider()
st.caption("Data processed and visualized for Hotel Amber 85 Data Analytics Test.")